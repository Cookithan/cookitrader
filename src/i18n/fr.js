...
export const FR = {
  ...
  about: {
    ...
    badge_new:    'Nouveau',
    older_show:   'Voir toute l\'histoire de l\'app ({n} versions)',
  ...
  portfolio: {
    ...
    current_loss:    'Perte actuelle',
    even:            "À l'équilibre",
    hold_since:      'Hold depuis',
    bonus_pct:       'Bonus +{n}%',
    no_bonus:        'Pas de bonus',
    next_tier:       'prochain palier : +{n}% à {at}',
  },
  ...
  market_card: {
    ...
    help_text:        'Plus les joueurs achètent, moins il en reste et plus le prix monte. Quand on vend, le stock revient.',
  },
