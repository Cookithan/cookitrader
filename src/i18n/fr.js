...
export const FR = {
  ...
  game_rider: {
    ...
    monde_label:  'NOUVEAU MONDE',
    monde_comptoir: 'Le Comptoir',
    monde_torrefaction: 'La Torréfaction',
    monde_creme:  'La Crème',
    monde_expresso: 'Plein Expresso',
    tag_flaque:   'CAFÉ RENVERSÉ !',
    tag_solo_0:   'ÇA PASSE !',
    tag_solo_1:   'PAS UNE GOUTTE !',
    tag_solo_2:   'PROPRE.',
    tag_double_0: 'DOUBLE RISTRETTO !',
    tag_double_1: "IL N'A RIEN SENTI !",
    tag_double_2: 'MAIS COMMENT ?!',
    tag_triple_0: 'PERSONNE NE FAIT ÇA',
    tag_triple_1: 'TRIPLE. TRIPLE !',
    tag_triple_2: 'LA MAISON OFFRE !',
    tag_loop_0:   'BOUCLÉ !',
    tag_loop_1:   "DANS L'ANNEAU !",
    end_plafond:  '💥 Dans la barre !',
    tag_solo_3:   'TRANQUILLE.',
    tag_double_3: 'DEUX. DEUX !',
    tag_triple_3: 'ARRÊTEZ-LE',
    tag_loop_2:   'PLEIN GAZ !',
    tag_frole_0:  'À DEUX DOIGTS !',
    tag_frole_1:  'IL A FROTTÉ !',
    tag_frole_2:  'JUSTE EN DESSOUS',
    tag_ligne_0:  'TOUTE LA LIGNE !',
    tag_ligne_1:  'PAS UNE DE PERDUE',
    tag_ligne_2:  'RAMASSAGE PARFAIT',
  ...
  games_list: {
    ...
    rider_desc:     'Maintiens pour accélérer, lâche pour poser',
    rider_reward:   'Jusqu\'à 320 cookies (coût 10🍪)',
    available:      'Dispo',
