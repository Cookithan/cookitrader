...
import { SentinelleChat } from "./components/overlays/SentinelleChat.jsx";
  ...
  return (
    ...
    <div style={{
      ...
      {vueSentinelle === 'console' && peutVoirSentinelle(userName, userCode) && (
        <SentinelleChat onClose={()=>setVueSentinelle(null)} onVoirDonnees={()=>setVueSentinelle('donnees')} userName={userName} />
      )}
