...
export default function CookiMiner() {
  ...
  const GAMES = [
    ...
    { id:'spin',    Icon:CircleDot,         title:'Roue de la chance',    desc:'Tentez votre chance',       reward:'Variable (coût 10🍪)',avail:coins>=10,   color:'#4A2C17', levelRequired:1 },
    ...
    { id:'pyramid', Icon:Cookie,            title:'Pyramide Cookie',      desc:'Empile sans rater',         reward:'10🍪/étage, max 200🍪', avail:true,        color:'#B86A28', levelRequired:8 },
  ];
