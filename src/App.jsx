...
export default function CookiMiner() {
  ...
  const GAMES = [
    ...
    { id:'guess',   Icon:HelpCircle,        title:'Devine la commande',   desc: level >= 10 ? '8 questions café' : '5 questions café', reward:'0 à 100 cookies (coût 5🍪)', avail:coins>=5,  color:'#8B5A2B', levelRequired:3 },
    ...
    { id:'pyramid', Icon:Coffee,            title:'Pile de Tasses',       desc:'Empile sans rater',         reward:'5 à 100 cookies (coût 10🍪)', avail:coins>=10, color:'#7D4E1F', levelRequired:10 },
