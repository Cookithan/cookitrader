...
export const DUELABLE_GAMES = [
  { key:'catcher', label:'Café Express', label_en:'Café Express', icon:'☕', higherWins:true,  metric:'points',  rules:'Attrape les cafés, évite les glaçons.',       botBand:[40,130], dur:60, how:'Glisse ta tasse en bas de l\'écran pour attraper les cafés ☕ et cookies 🍪 qui tombent. Évite les glaçons 🧊 qui figent ta tasse.' },
  { key:'flappy',  label:'Flappy',       label_en:'Flappy',       icon:'🥐', higherWins:true,  metric:'tuyaux',  rules:'Passe entre un max de viennoiseries.',        botBand:[4,14],   dur:30, how:'Tape l\'écran pour faire monter ton cookie et passe entre les viennoiseries sans les toucher. Chaque passage = 1 point.' },
  { key:'click',   label:'Clic',         label_en:'Click',        icon:'🍪', higherWins:true,  metric:'clics',   rules:'Clique le cookie le plus vite possible.',     botBand:[22,55],  dur:5,  how:'Tape le cookie le plus vite possible pendant le temps imparti. Un max de clics = un max de points.' },
  { key:'reflex',  label:'Réflexe',      label_en:'Reflex',       icon:'⚡', higherWins:true,  metric:'cookies', rules:'Tape les cookies dès qu\'ils apparaissent.',  botBand:[5,18],   dur:15, how:'Un cookie surgit quelque part à l\'écran → tape-le vite ! Rate-en un (il disparaît) et tu perds un point.' },
  { key:'memory',  label:'Memory',       label_en:'Memory',       icon:'🧠', higherWins:false, metric:'coups',   rules:'Retrouve les paires en un min. de coups.',    botBand:[8,16],   dur:25, how:'Retourne les cartes 2 par 2 et retrouve toutes les paires. Le moins de coups possible = le mieux (moins = mieux).' }, // moins = mieux
  { key:'pyramid', label:'Pyramide',     label_en:'Pyramid',      icon:'🔺', higherWins:true,  metric:'tasses',  rules:'Empile les tasses le plus haut possible.',    botBand:[5,20],   dur:30, how:'Les tasses glissent d\'un côté à l\'autre → tape au bon moment pour les empiler. Plus haut tu montes, mieux c\'est.' },
  { key:'guess',   label:'Devine',       label_en:'Guess',        icon:'❓', higherWins:true,  metric:'bonnes réponses', rules:'Devine la commande du client.',       botBand:[2,5],    dur:18, how:'Un client passe commande → devine la bonne réponse parmi les propositions. Un max de bonnes réponses gagne.' },
];
