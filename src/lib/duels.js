...
export const DUELABLE_GAMES = [
  { key:'catcher', label:'Café Express', label_en:'Café Express', icon:'☕', higherWins:true,  metric:'points',  rules:'Attrape les cafés, évite les glaçons.',       botBand:[70,160], dur:60, how:'Glisse ta tasse en bas de l\'écran pour attraper les cafés ☕ et cookies 🍪 qui tombent. Évite les glaçons 🧊 qui figent ta tasse.' },
  { key:'flappy',  label:'Flappy',       label_en:'Flappy',       icon:'🥐', higherWins:true,  metric:'tuyaux',  rules:'Passe entre un max de viennoiseries.',        botBand:[6,24],   dur:30, how:'Tape l\'écran pour faire monter ton cookie et passe entre les viennoiseries sans les toucher. Chaque passage = 1 point.' },
  ...
  { key:'reflex',  label:'Réflexe',      label_en:'Reflex',       icon:'⚡', higherWins:true,  metric:'cookies', rules:'Tape les cookies dès qu\'ils apparaissent.',  botBand:[6,22],   dur:15, how:'Un cookie surgit quelque part à l\'écran → tape-le vite ! Rate-en un (il disparaît) et tu perds un point.' },
  ...
  { key:'pyramid', label:'Pyramide',     label_en:'Pyramid',      icon:'🔺', higherWins:true,  metric:'tasses',  rules:'Empile les tasses le plus haut possible.',    botBand:[7,26],   dur:30, how:'Les tasses glissent d\'un côté à l\'autre → tape au bon moment pour les empiler. Plus haut tu montes, mieux c\'est.' },
