...
export const CHANGELOG = [
  {
    ...
    changes: [
      "🏅 Les bonus de niveau suivent enfin l’effort : ils plafonnaient à 290 🍪 alors que le palier coûtait 40 000 XP. Le niveau 25 rapporte désormais 600 🍪, et les grands paliers versent les cookies EN PLUS du café",
    ...
    changes_en: [
      "🏅 Level-up bonuses finally follow the effort: they capped at 290 🍪 while a tier cost 40,000 XP. Level 25 now pays 600 🍪, and the big tiers grant cookies ON TOP of the coffee",
