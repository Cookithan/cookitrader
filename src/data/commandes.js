...
export const COMMANDES = [
  ...
  { absurd:true, desc:"Je cherche un café fait à partir d'eau de pluie tombée un mardi.",
  ...
  { absurd:true, desc:"Je voudrais un café qui sente le dimanche après-midi mais en pleine semaine.",
    choices:['Latte temporel','Espresso paresseux','Mocha sieste','Café week-end'], answer:3 },
  ...
  { absurd:true, desc:"Une boisson qui ferait pleuvoir des cookies du ciel ? Pour mon mariage.",
    choices:['Latte météorologique','Espresso pluie de cookies','Mocha cumulus','Café climatologique'], answer:1 },
  ...
  { absurd:true, desc:"Je voudrais un café qui négocierait mon augmentation à ma place.",
    choices:['Espresso syndical','Mocha avocat','Latte du courage','Cappuccino RH'], answer:3 },
];
